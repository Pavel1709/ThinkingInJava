...
//решение из интернета. Не понимаю, где тут "to handle both the general case of a Set interface as shown, and the special case of an EnumSet, using clone( ) instead of creating a new HashSet". Вот в своем примере я пытался сделать и то, и другое, но не смог. Возможно, я неправильно понял задание.