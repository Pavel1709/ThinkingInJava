...
public class Comp  implements Comparable<Comp> {
    ...
    public int hashCode() {
     int result = 17;
     result = result* 37 + s1.hashCode();
     result = result* 37 + s2.hashCode();
     return result;
    }
    public boolean equals(Object o) {
     return o instanceof Comp && s1.equals(((Comp)o).s1) && s2.equals(((Comp)o).s2);
    } 
    ...
    HashMap<Comp, String> hm = new HashMap<Comp, String>();
    HashSet<Comp> hs = new HashSet<Comp>();
    hm.put(new Comp("a","a") , "b");
