...
public class Maps {
  public static void printKeys1(Map<Integer,String> map) {
  ...
  public static void test2(Map<Object,Object> map) {
    ...
    keys.addAll(Collections.list(p.propertyNames()));
    //System.out.println(keys);
    //List<Object> properties = new ArrayList<Object>();
    for(Object o: keys) {
      //properties.add(p.getProperty((String)o));
      map.put(o, p.getProperty((String)o));
    }
    for(Object o: keys) {
      //properties.add(p.getProperty((String)o));
      map.put(o, p.getProperty((String)o));
  ...
  //  test2(new HashMap<Integer,String>());
    test(new TreeMap<Integer,String>());
    test(new LinkedHashMap<Integer,String>());
    test(new IdentityHashMap<Integer,String>());
    test(new ConcurrentHashMap<Integer,String>());
    test(new WeakHashMap<Integer,String>());
    test2(new HashMap<Object,Object>());
    test2(new TreeMap<Object,Object>());
    test2(new LinkedHashMap<Object,Object>());
    test2(new IdentityHashMap<Object,Object>());
    test2(new ConcurrentHashMap<Object,Object>());
    test2(new WeakHashMap<Object,Object>());
  }
} /* Output:
HashMap
