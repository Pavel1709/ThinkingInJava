...
public class GreenhouseController {
  ...
  AdditionalClass gc = new AdditionalClass(); // Instead of hard-wiring, you could parse
  ...
  Event[] eventList = { gc.new ThermostatNight(0), 
   ...
   gc.new VklProvet(1300),
   gc.new VklProvet(1500),
   gc.new vklUvlazh(1600),
   gc.new ViklUvlazh(1600),
  };
