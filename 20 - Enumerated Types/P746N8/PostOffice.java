...
class Mail {
  ...
  enum RedirectAddress { NO, OK1,OK2,OK3,OK4,OK5}
  ...
  public String details() {
    return toString() +
      ...
      ", Redirect address: " + redirectAddress;
  }
  // Generate test Mail:
  public static Mail randomMail() {
    ...
    m.redirectAddress = Enums.random(RedirectAddress.class);
    return m;
  }
...
public class PostOffice {
  enum MailHandler {
    ...
    REDIRECT_TO {
      boolean handle(Mail m) {
        switch(m.redirectAddress) {
          case NO: return false;
          default: print("redirecting " + m);
            return true;        
        }
      }
    };
