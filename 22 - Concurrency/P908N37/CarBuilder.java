...
class Car {
  ...
  private boolean
    engine = false, driveTrain = false, wheels = false, colour = false;
  ...
  public synchronized void addWheels() { wheels = true; }
   public synchronized void addColour() { colour = true; }
  ...
  public void run() {
    try {
      while(!Thread.interrupted()) {
        ...
        robotPool.hire(ColourRobot.class, this);
...
class ColourRobot extends Robot {
  public ColourRobot(RobotPool pool) { super(pool); }
  protected void performService() {
    print(this + " painting ");
    assembler.car().addColour();
  }
}
class RobotPool {
...
public class CarBuilder {
  public static void main(String[] args) throws Exception {
    ...
    exec.execute(new ColourRobot(robotPool));
