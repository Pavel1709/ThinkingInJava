...
public class ListPerformance {
  ...
  static List<Test<FastTraversalLinkedList<Integer>>> ltests =
  ...
  static {
    ...
    qTests.add(new Test<LinkedList<Integer>>("rmLast") {
      ...
      ltests.add(new Test<FastTraversalLinkedList<Integer>>("add") {
      int test(FastTraversalLinkedList<Integer> list, TestParam tp) {
        ...
        ltests.add(new Test<FastTraversalLinkedList<Integer>>("iteradd") {
      int test(FastTraversalLinkedList<Integer> list, TestParam tp) {
        final int LOOPS = 1000000;
        int half = (list.size() ) / 2;
        ListIterator<Integer> it = list.listIterator(half);
    ...
    ltests.add(new Test<FastTraversalLinkedList<Integer>>("insert") {
      int test(FastTraversalLinkedList<Integer> list, TestParam tp) {
        int loops = tp.loops;
        for(int i = 0; i < loops; i++)
        ...
        return loops;
          ...
          ltests.add(new Test<FastTraversalLinkedList<Integer>>("get") {
      int test(FastTraversalLinkedList<Integer> list, TestParam tp) {
        int loops = tp.loops * reps;
        int listSize = list.size() ;
        for(int i = 0; i < loops; i++)
    ...
    ltests.add(new Test<FastTraversalLinkedList<Integer>>("remove") {
      int test(FastTraversalLinkedList<Integer> list, TestParam tp) {
        int loops = tp.loops;
        int size = tp.size;
        for(int i = 0; i < loops; i++) {
  ...
  public static void main(String[] args) {
    ...
    qTest.timedTest(); 
    Tester<FastTraversalLinkedList<Integer>> lTest = new Tester<FastTraversalLinkedList<Integer>>(new FastTraversalLinkedList<Integer>(), ltests);
    lTest.setHeadline("FastTraversalLinkedList tests");
    lTest.timedTest(); 
  }
} /* Output: (Sample)
--- Array as List ---
