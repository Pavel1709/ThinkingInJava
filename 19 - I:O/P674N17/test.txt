...
public class TextFile extends ArrayList<String> {
  ...
  public static void main(String[] args) {
    ...
    TextFile txt = new TextFile("TextFile.java", " ");
    text.write("test3.txt");
    TextFile txt2 = new TextFile("test3.txt", "");
    for(String w: txt2) {
     if (!map.keySet().contains(w.charAt(0))) {
      map.put(w.charAt(0), 1);
     } 
     else {
      map.put(w.charAt(0), map.get(w.charAt(0))+1);
     }
    }
